...
3. Verifica que se genere `traitor.amx`.
4. Configura el archivo `server.cfg`, apuntando el gamemode al archivo generado en el paso anterior.
5. Inicia el servidor SA-MP mediante el ejecutable `samp-server.exe`.
